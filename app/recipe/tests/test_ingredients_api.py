...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_retrieve_ingredients_assigned_to_recipes(self):
        ...
        ingredient1 = sample_ingredient(user=self.user, name='Egg noodles')
        ingredient2 = sample_ingredient(user=self.user, name='Rice')
        recipe = sample_recipe(user=self.user, title='Chicken noodle soup')
    ...
    def test_retrieve_ingredients_assigned_unique(self):
        ...
        ingredient = sample_ingredient(user=self.user, name='Flour')
        recipe1 = sample_recipe(user=self.user, title='Apple Pie')
        recipe1.ingredients.add(ingredient)
        recipe2 = sample_recipe(user=self.user, title='Banana Bread')
